...
export class AppComponent implements OnInit {
  ...
  constructor(
    ...
    iconRegistry.addSvgIconLiteral('india-flag', sanitizer.bypassSecurityTrustHtml(INDIA_FLAG_ICON));

    // this.matIconRegistry.addSvgIcon(
    //   "india-flag",
    //   this.domSanitizer.bypassSecurityTrustResourceUrl("../india-flag-icon.svg")
    // );
  }
